...
export const PropertyList: PropertyItem[] = [
  {
    propertyID: 1,
    title: 'The Millennium Residences',
    beds: '3 beds',
    baths: '3 baths',
    area: '1989 ft²',
    image: bostonHouse,
    images: boston,
    location: 'Boston, MA, United States, 240 Devonshire Street',
    price: '$4,875,000',
    description:
  ...
  {
    propertyID: 2,
    title: 'Monarch Tysons',
    beds: '2 beds',
    baths: '2 baths',
    area: '2284 ft²',
    image: virginiaHouse,
    images: virginia,
    location: 'McLean, VA, United States, 7887 Jones Branch Drive',
    price: '$2,395,000',
    description:
      'The Residences at Winthrop Center: proof that “living centered” is the ultimate luxury. These spectacular residences currently rising in the center of the city will sit atop what will be the largest Passive House office building in the world. They’ll feature climate-positive design and panoramic harbor and city views. The best news of all? Residential sales have officially commenced! The Residences at Winthrop Center lifestyle will begin with Millennium’s signature five-star service and an unprecedented 50,000+ sq. ft. of total luxury amenity space spanning two floors. This includes The Club, with expansive owner’s lounge, two sprawling outdoor terraces, screening room, bar, and more, all supported by Millennium’s exclusive social calendar, La Vie®. The private FLX Wellness Sanctuary will offer state-of-the-art fitness equipment, Pilates and yoga, tranquil treatment and recovery rooms, and a 75-foot indoor lap pool, among other special features.',
  },
  {
    ...
    image: montanaHouse,
    images: montana,
    location: 'Big Sky, MT, United States, 66 Mountain Loop Rd',
    price: '$12,650,000',
    description:
  ...
  {
    propertyID: 4,
    title: 'TRIBUNE TOWER RESIDENCES',
    beds: '4 beds',
    baths: '4 baths',
    area: '4185 ft²',
    image: illinoisHouse,
    images: illinois,
    location: 'Chicago, IL, United States, 435  Michigan Avenue',
    price: '$6,675,000',
    description:
  ...
  },
  {
    ...
    image: nycHouse,
    images: nyc,
    location: '555 W 22nd St, New York, NY 10011, USA',
    price: '$25,000,000',
    description:
...
export const getPropertyById = (propertyID: number) =>
  PropertyList.find((property) => property.propertyID === propertyID);
