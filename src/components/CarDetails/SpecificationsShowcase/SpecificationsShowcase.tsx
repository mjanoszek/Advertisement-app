      ...
      <div className='bg-black'>
        ...
        <div className='px-5'>
          ...
          <div className='mt-4 flex w-full justify-center gap-2 text-xs text-white'>
            <button
              className={`flex-1 rounded-sm border px-5 py-2 ${
            ...
            <button
              className={`flex-1 rounded-sm border border-gray-800 px-5 py-2 ${
        ...
        {specificationItem === 'Model S Plaid' ? (
          <div className='flex'>
            <div className='flex flex-1 flex-col gap-5 p-5'>
              ...
              />
              <SpecificationsItem heading={'Weight'} description={'2,167 kg'} />
              <SpecificationsItem
          ...
          <div className='flex'>
            <div className='flex flex-1 flex-col gap-5 p-5'>
              ...
              <SpecificationsItem
                ...
                description={'793 liters'}
              />
              <SpecificationsItem heading={'Weight'} description={'2,068 kg'} />
              <SpecificationsItem
                heading={'Supercharging Max'}
                description={'250 kW'}
              />
